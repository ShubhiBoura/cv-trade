...
export const BASE_URL = 'https://api.ctexexchange.com/';
// export const BASE_URL = 'https://api.kexchange.co/';
// export const BASE_URL_IP = 'http://65.1.155.112:3002/';
export const CAPTCHA_KEY = '6LdJOP0mAAAAAAKW2BBU7NICdh7twFQVWGEjzAd6';
export const SITE_URL = 'http://taxbits.io';
...
export const errorText = {
  ...
  confirmPan: 'PAN Number Mismatch',
  ...
  accountType: ' Please Provide Valid Account Type',
  ...
  passbook: 'Please Provide Valid Image of Bank Passbook',
