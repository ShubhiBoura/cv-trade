...
const WalletDetails = () => {
  ...
  const onDeposit = () => {
    short_name === 'INR'
      ? NavigationService.navigate(DEPOSIT_INR_SCREEN, {walletDetail: detail})
      : NavigationService.navigate(DEPOSIT_SCREEN, {walletDetail: detail});
  };
  const onWidthDraw = () => {
    short_name === 'INR'
      ? NavigationService.navigate(WITHDRAW_INR_SCREEN, {walletDetail: detail})
      : NavigationService.navigate(WITHDRAW_SCREEN, {walletDetail: detail});
  };
