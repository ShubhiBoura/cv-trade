...
import { AppText, FIFTEEN, FOURTEEN, MEDIUM, SECOND, SEMI_BOLD, TEN, THIRD } from '../../common';
  ...
  return (
    ...
    <View style={styles.tabConatiner}>
      <View style={styles.firstTab}>
        <AppText weight={MEDIUM} type={FOURTEEN} style={styles.numberStyle}>1</AppText>
      </View>
      <View style={[styles.border, { backgroundColor: colors.buttonBg }]}></View>
      <View style={styles.otherTab}>
        <AppText weight={MEDIUM} color={THIRD} type={FOURTEEN} style={styles.numberStyle}>2</AppText>
      </View>
      <View style={[styles.border, { backgroundColor: colors.white }]}></View>
      <View style={styles.otherTab}>
        <AppText weight={MEDIUM} color={THIRD} type={FOURTEEN} style={styles.numberStyle}>3</AppText>
      </View>
    </View>
    <AppText weight={MEDIUM} type={FIFTEEN}
      style={styles.heading}>Available to stake</AppText>
    <View style={{ marginTop: 10 }}>
    </View>
    <FlatList
      data={stakingData}
      renderItem={stakingRenderItem}
    />
