...
import { APP_THEME_BG, graphIcon, historyIcon, starFillIcon, starIcon } from '../helper/imageAssets';
...
const BtcCoinDetails = () => {
                ...
                <View style={styles.nameContainer}>
                    <View>
                        ...
                        <View
                            ...
                            <AppText style={{color:colors.black}} weight={SEMI_BOLD}>
                                {toFixedThree(change)}
                            </AppText>
                        </View>
                    </View>
        ...
        return (
            <View style={{ flex: 1.5, marginEnd: 10 }}>
                ...
                <TouchableOpacityView
                    ...
                    <FastImage source={downIcon} tintColor={colors.white} resizeMode='contain' style={{ height: 10, width: 10 }} />
                </TouchableOpacityView>
          ...
          />
                ...
                <Button
                    ...
                    containerStyle={[
                        styles.mainButton,
                        { backgroundColor: isBuy ? colors.buyColor : colors.red },
                    ]}
                    onPress={() => onSubmit()}
                ...
                <View style={styles.mainView}>
                    <TouchableOpacityView
                        ...
                        {colorId == '1' ?
                            ...
                            : colorId == '2' ? <View style={styles.onlyRedBox} /> :
                    ...
                    <TouchableOpacityView
                        ...
                        <FastImage source={downIcon} tintColor={colors.white} resizeMode='contain' style={styles.selectDown} />
                    </TouchableOpacityView>
                </View>
                {colorId == '1' ?
                    <>
                        <View style={styles.bottomContainer3}>
                            ...
                            <View>
                                ...
                                {lastSixObjects?.map(e => {
                                    return <AppText type={TEN}>{e?.quantity.toFixed(numberSelect.length)}</AppText>;
                                })}
                            </View>
                        </View>
                        ...
                        <View style={styles.bottomContainer2}>
                            <View>
                                ...
                                {startingSixObjects?.map(e => {
                                    return (
                                        <AppText style={{color:colors.buyColor}} type={TEN}>
                                            {e?.price.toFixed(numberSelect.length)}
                                        </AppText>
                                    );
                                })}
                    ...
                    return (
                        <TouchableOpacityView
                            ...
                            {item.multyColor ?
                                ...
                                : item.red ? <View style={styles.onlyRedBox} /> :
                                    <View style={styles.onlyGreenBox} />
                            }
                        </TouchableOpacityView>
                    )
                ...
                return (
                    <TouchableOpacityView
                        ...
                        {numberSelect == item.label ?
                            <FastImage source={checkIc}
                                tintColor={colors.green} resizeMode='contain' style={styles.checkImage} />
                            : <></>}
                    </TouchableOpacityView>
                )
            })
    ...
    return (
        <AppSafeAreaView source={APP_THEME_BG} isMargin={false}>
            <KeyBoardAware>
                {coinHeader()}
                <View style={styles.mainView}>
                    {buySellContainer()}
                ...
                <View
                    ...
                    <OpenOrderFound setGetIndex={setGetIndex}/>
                </View>
            </KeyBoardAware>
